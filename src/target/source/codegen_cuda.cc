    ...
    if (shape == "m8n8k4") {
      ...
      if ((A_dtype == "fp16") && (B_dtype == "fp16")) {
        ...
        if (C_dtype == "fp16") {
          ...
          a_ref = "((unsigned *)(" + a_ref + " + " + a_bias + "))";
          b_ref = "((unsigned *)(" + b_ref + " + " + b_bias + "))";
          c_ref = "((unsigned *)(" + c_ref + " + " + c_bias + "))";
          asm_code = R"(
            {
        ...
        a_ref = "((double *)(" + a_ref + " + " + a_bias + "))";
        b_ref = "((double *)(" + b_ref + " + " + b_bias + "))";
        c_ref = "((double *)(" + c_ref + " + " + c_bias + "))";
        asm_code = R"(
          {
            __asm__ __volatile__(
